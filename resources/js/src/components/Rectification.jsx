            ...
            <form className="p-fluid" onSubmit={handleOnSubmit}>
                ...
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    <label htmlFor="description">
                        Description of Data to be Rectified
                    </label>
                    <InputTextarea
                        name="description"
                        value={data.description}
                        onChange={handleOnChange}
                        placeholder="Enter description of data to be rectified"
                        rows={4}
                    />
                </div>
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                ...
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    <div className="field-checked tw-flex tw-items-center tw-text-gray-900 ">
                        ...
                        >
                            I hereby request rectification of my personal data
                            held by Tritek Consulting Ltd
                        </label>
                    </div>
                </div>
