            ...
            <form className="p-fluid" onSubmit={handleOnSubmit}>
                ...
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    <label htmlFor="description">
                        Description of Data to be Restricted
                    </label>
                    <InputTextarea
                        name="description"
                        value={data.description}
                        onChange={handleOnChange}
                        placeholder="Enter description of data to be restricted"
                        rows={4}
                    />
                </div>
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    ...
                    <InputTextarea
                        ...
                        value={data.reason}
                        onChange={handleOnChange}
                        placeholder="Enter reason for restriction request"
                        rows={4}
                    />
                </div>
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    <div className="field-checked tw-flex tw-items-center tw-text-gray-900 ">
                        ...
                        >
                            I hereby request restriction of processing of my
                            personal data held by Tritek Consulting Ltd.
                        </label>
                    </div>
                </div>
