            ...
            <form className="p-fluid" onSubmit={handleOnSubmit}>
                ...
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    <label htmlFor="description">
                        Description of Data Processing for Which Consent is
                        Withdrawn
                    </label>
                    <InputTextarea
                        name="description"
                        ...
                        onChange={handleOnChange}
                        placeholder="Enter description of data processing for which consent is withdrawn"
                        rows={4}
                    />
                </div>
                <div className="tw-flex tw-flex-col tw-gap-1 tw-mb-6">
                    <div className="field-checked tw-flex tw-items-center tw-text-gray-900 ">
                        ...
                        >
                            I hereby withdraw my consent for the processing of
                            my personal data by Tritek Consulting Ltd
                        </label>
                    </div>
                </div>
